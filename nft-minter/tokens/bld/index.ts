...
const TOKEN_NAME = "Horse";
const TOKEN_SYMBOL = "HRS";
const TOKEN_DESCRIPTION = "A token for horse lovers";
const TOKEN_IMAGE_NAME = "horse.png"; // Replace unicorn.png with your image name
